...
public class Tablespaces implements Runnable {
    ...
    public HashMap<String, TableSpaceInfo> tablespaces;
            ...
            while(rs.next()) {
                if(tablespaces.get(rs.getString(1)) != null)
                    tablespaces.replace(rs.getString(1),
                                new TableSpaceInfo(rs.getString(1), rs.getFloat(2), rs.getFloat(3), rs.getFloat(4), rs.getFloat(5), rs.getFloat(6)));
